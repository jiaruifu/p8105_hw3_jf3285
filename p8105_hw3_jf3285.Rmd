...
Q1. There are 134 aisles. Aisle 83 (fresh vegetables, most) and aisle 24 (fresh fruits, second most) are the most items ordered from.  
  Q2. The plot is shown above. Aisles are arranged by their respective IDs.
...
Q1. The final dataset includes the week number from 1 to 5 [dbl], the day_id from 1 to 7 representing the seven days in week [dbl], the day of the week from Monday to Sunday [chr], the weekday vs weekend variable representing if the day is weekday or weekend [chr], minute representing the minute of a day [dbl], and minute activity [dbl].  
  Q2. In the table that shows total activity over the day, there are not many apparent trends. But it can be easily seen that the total activities for Week 1 Monday, Week 4 Saturday and Week 5 Saturday are extremely low compared to those of other days.  
    Q3. In the plot that shows the 24-hour activity time courses for each day, it can be seen that the peaks of activity for each day are around Thursday at 6am, Sunday at 11am, Saturday at 16pm, and Monday and Friday at 20pm. 
